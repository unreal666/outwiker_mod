...
class ParserListTest (unittest.TestCase):
    ...
    def testUnorderList2 (self):
        text = u"бла-бла-бла \n\n*'''Строка 1'''\n* ''Строка 2''\n* Строка 3\nбла-бла-бла"
        result = u'бла-бла-бла \n\n<ul><li><b>Строка 1</b></li><li><i>Строка 2</i></li><li>Строка 3</li></ul>\nбла-бла-бла'
    ...
    def testUnorderListStrike (self):
        text = u"бла-бла-бла \n\n*{-Строка 1-}\n* {-Строка 2-}\n* Строка 3\nбла-бла-бла"
        result = u'бла-бла-бла \n\n<ul><li><strike>Строка 1</strike></li><li><strike>Строка 2</strike></li><li>Строка 3</li></ul>\nбла-бла-бла'
    ...
    def testOrderList1 (self):
        text = u"бла-бла-бла \n\n#Строка 1\n# Строка 2\n# Строка 3\nбла-бла-бла"
        result = u'бла-бла-бла \n\n<ol><li>Строка 1</li><li>Строка 2</li><li>Строка 3</li></ol>\nбла-бла-бла'
    ...
    def testOrderList2 (self):
        text = u"бла-бла-бла \n\n#'''Строка 1'''\n# ''Строка 2''\n# Строка 3\nбла-бла-бла"
        result = u'бла-бла-бла \n\n<ol><li><b>Строка 1</b></li><li><i>Строка 2</i></li><li>Строка 3</li></ol>\nбла-бла-бла'
    ...
    def testOrderListStrike (self):
        text = u"бла-бла-бла \n\n#{-Строка 1-}\n# {-Строка 2-}\n# Строка 3\nбла-бла-бла"
        result = u'бла-бла-бла \n\n<ol><li><strike>Строка 1</strike></li><li><strike>Строка 2</strike></li><li>Строка 3</li></ol>\nбла-бла-бла'
    ...
    def testEnclosureUnorderList1 (self):
        text = u"бла-бла-бла \n\n*Строка 1\n* Строка 2\n** Вложенная строка 1\n**Вложенная строка 2\n* Строка 3\nбла-бла-бла"
        result = u'бла-бла-бла \n\n<ul><li>Строка 1</li><li>Строка 2</li><ul><li>Вложенная строка 1</li><li>Вложенная строка 2</li></ul><li>Строка 3</li></ul>\nбла-бла-бла'
    ...
    def testEnclosureOrderList1 (self):
        text = u"бла-бла-бла \n\n#Строка 1\n# Строка 2\n## Вложенная строка 1\n##Вложенная строка 2\n# Строка 3\nбла-бла-бла"
        result = u'бла-бла-бла \n\n<ol><li>Строка 1</li><li>Строка 2</li><ol><li>Вложенная строка 1</li><li>Вложенная строка 2</li></ol><li>Строка 3</li></ol>\nбла-бла-бла'
...
* Строка 3
бла-бла-бла"""
        result = u'бла-бла-бла\n\n<ul><li>Строка 1 вторая строка</li><li>Строка 2</li><li>Строка 3</li></ul>\nбла-бла-бла'
...
# Строка 3
бла-бла-бла"""
        result = u'бла-бла-бла\n\n<ol><li>Строка 1 вторая строка</li><li>Строка 2</li><li>Строка 3</li></ol>\nбла-бла-бла'
