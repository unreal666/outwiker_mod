...
polyactionsList = [
    ...
    (polyactions.BOLD_ITALIC_STR_ID, _(u"Bold italic"),
    ...
    (polyactions.PREFORMAT_STR_ID, _(u"Preformatted text"),
    _(u"Preformatted text"), HotKey("B", ctrl=True, shift=True)),
    (polyactions.CODE_STR_ID, _(u"Insert code"),
     _(u"Insert code(monospaced font)"), None),

    (polyactions.ALIGN_LEFT_STR_ID, _(u"Align text left"),
    _(u"Align text left"), HotKey("L", ctrl=True, shift=True)),
    (polyactions.ALIGN_CENTER_STR_ID, _(u"Align text center"),
     _(u"Center"), HotKey("C", ctrl=True, shift=True)),
    (polyactions.ALIGN_RIGHT_STR_ID, _(u"Align text right"),
    _(u"Align text right"), HotKey("R", ctrl=True, shift=True)),
    (polyactions.ALIGN_JUSTIFY_STR_ID, _(u"Justify"),
    _(u"Justify"), HotKey("J", ctrl=True, shift=True)),
    ...
    (polyactions.HORLINE_STR_ID, _(u"Horizontal rule"),
    _(u"Horizontal rule"), HotKey("H", ctrl=True, shift=True)),
    (polyactions.LINK_STR_ID, _(u"Link"),
    _(u"Insert Link"), HotKey("L", ctrl=True)),
    (polyactions.QUOTE_STR_ID, _(u"Quote"),
    _(u"Insert a quote block"), HotKey("Q", ctrl=True)),
    (polyactions.IMAGE_STR_ID, _(u"Image"),
    _(u"Insert image"), HotKey("M", ctrl=True, shift=True)),
    ...
    (polyactions.LIST_DEFINITIONS_STR_ID, _(u"Definition list"),
    _(u"Insert a definition list"), None),
    ...
    (polyactions.LINE_BREAK_STR_ID, _(u"Line break"),
    ...
    (polyactions.TABLE_STR_ID, _(u"Table"),
    _(u"Insert a table"), HotKey("T", ctrl=True, shift=True)),
    (polyactions.TABLE_ROW_STR_ID, _(u"Table rows"),
    _(u"Insert table rows"), HotKey("G", ctrl=True, shift=True)),
    (polyactions.TABLE_CELL_STR_ID, _(u"Table cell"),
    _(u"Insert a table cell"), HotKey("U", ctrl=True, shift=True)),

    (polyactions.CURRENT_DATE, _(u"Current date"),
     _(u"Insert the current date"), None),
    (polyactions.SPELL_ON_OFF_ID, _(u"Spell checking"),
    _(u"Enable / disable spell checking"), HotKey("F7")),

    (polyactions.LINE_DUPLICATE_ID, _(u"Duplicate line"),
    _(u"Duplicate current line"), HotKey("D", ctrl=True, shift=True)),
    ...
    (polyactions.DELETE_WORD_LEFT, _(u"Delete word to the left"),
    _(u"Delete text to beginning of the word"), HotKey("Back", ctrl=True)),
    (polyactions.DELETE_WORD_RIGHT, _(u"Delete word to the right"),
    _(u"Delete text to ending of the word"), HotKey("Delete", ctrl=True)),
    (polyactions.DELETE_LINE_LEFT, _(u"Delete to start of the line"),
    _(u"Delete text back from the current position to the start of the line"), HotKey("Back", ctrl=True, shift=True)),
    (polyactions.DELETE_LINE_RIGHT, _(u"Delete to end of the line"),
    _(u"Delete text forwards from the current position to the end of the line"), HotKey("Delete", ctrl=True, shift=True)),

    (polyactions.GOTO_PREV_WORD, _(u"Go to previous word"),
    _(u"Move cursor to previous word"), HotKey("Left", ctrl=True)),
    (polyactions.GOTO_NEXT_WORD, _(u"Go to next word"),
    _(u"Move cursor to next word"), HotKey("Right", ctrl=True)),
    (polyactions.GOTO_PREV_WORD_SELECT, _(u"Go to previous word and select"),
    _(u"Move cursor to previous word and select text"), HotKey("Left", ctrl=True, shift=True)),
    (polyactions.GOTO_NEXT_WORD_SELECT, _(u"Go to next word and select"),
    _(u"Move cursor to next word and select text"), HotKey("Right", ctrl=True, shift=True)),
    ...
    (polyactions.TEXT_COLOR_STR_ID, _(u"Text color..."),
    _(u"Set text color"), HotKey("K", ctrl=True, shift=True)),
